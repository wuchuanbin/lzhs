...
<div class="navbar">
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <a class="brand" href="index.html"><span class="first">桐乡</span> <span class="second">老志画室</span></a>
        </div>
    </div>
</div>
        ...
        <div class="span3">
            <div class="sidebar-nav">
                ...
                <ul id="accounts-menu" class="nav nav-list collapse in">
                    <li ><a href="/index.php?m=Manager&a=ClassList">班级列表</a></li>
                    <li ><a href="/index.php?m=Manager&a=NoticeList">班级通知</a></li>
                    <li ><a href="/index.php?m=Manager&a=PhotoList">班级相册</a></li>
                </ul>

                <div class="nav-header" data-toggle="collapse" data-target="#settings-menu"><i class="icon-exclamation-sign"></i>文章管理</div>
                <ul id="settings-menu" class="nav nav-list collapse in">
                    <li ><a href="xxx">分类管理</a></li>
                    <li ><a href="xxx">文章列表</a></li>
                    <!--<li ><a href="500.html">500 page</a></li>
                    <li ><a href="503.html">503 page</a></li>-->
                </ul>

                <div class="nav-header" data-toggle="collapse" data-target="#legal-menu"><i class="icon-legal"></i>作业管理</div>
                <ul id="legal-menu" class="nav nav-list collapse in">
                    <li ><a href="/index.php?m=Manager&a=HomeWorkList">历时作业</a></li>
                    <li ><a href="/index.php?m=Manager&a=UpWork">批量上传作业</a></li>
                </ul>
            </div>
        </div>
